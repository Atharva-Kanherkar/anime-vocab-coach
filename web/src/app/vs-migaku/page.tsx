      ...
      <main id="main">
        ...
        <CompareHero
          ...
          lede={
            <>
              ...
              <strong>power-user immersion suite</strong>, the most capable browser-based
              sentence-mining setup in 2026. AnimeVocab is a <strong>zero-setup on-ramp</strong> for
              someone who just started and can&apos;t read kana yet. The right pick depends entirely on
              how much machinery you want.
            </>
          }
        ...
        <section style={{ paddingTop: 0 }}>
          <div className="wrap prose">
            ...
            <h2>Why AnimeVocab is the better default</h2>
            <p>
