...
const staticRoutes = [
  ...
  { path: "/anki-vs-migaku", priority: 0.88, changeFrequency: "weekly" as const },
  { path: "/manabidojo-alternative", priority: 0.9, changeFrequency: "weekly" as const },
  { path: "/animelon-alternative", priority: 0.9, changeFrequency: "weekly" as const },
  { path: "/language-reactor-alternative", priority: 0.9, changeFrequency: "weekly" as const },
  { path: "/asbplayer-alternative", priority: 0.88, changeFrequency: "weekly" as const },
  ...
  { path: "/vs-migaku", priority: 0.88, changeFrequency: "weekly" as const },
  ...
  { path: "/vs-manabidojo", priority: 0.86, changeFrequency: "weekly" as const },
