...
const staticRoutes = [
  ...
  { path: "/migaku-vs-language-reactor", priority: 0.9, changeFrequency: "weekly" as const, lastModified: "2026-07-11" },
  ...
  { path: "/language-reactor-alternative", priority: 0.9, changeFrequency: "weekly" as const, lastModified: "2026-07-11" },
  ...
  { path: "/learn-japanese-crunchyroll", priority: 0.88, changeFrequency: "monthly" as const, lastModified: "2026-07-14" },
