...
export const CARDS: CardDef[] = [
  ...
  // — the saga's key figures (the manga's guide, rival, and the Court of Erasure) —
  { id: "nc_tsuru", name: "Tsuru", kanji: "紙", reading: "かみ", epithet: "The Paper Courier", rarity: "N", level: 1, style: "spirit", look: "a small origami paper crane folded from a printed dictionary page, tiny type still legible on its wings, edges gently scorched, trailing a faint thread of light, expressive and alive, watercolor" },
  { id: "nc_echo", name: "Kael", kanji: "響", reading: "ひびき", epithet: "The Word-Thief", rarity: "R", level: 28, style: "shadow", look: "a lean Icelandic young man with pale eyes and windswept ash-blond hair in a long grey coat, standing on basalt columns, stolen words drifting around him like glowing moths, haunted and guarded, cool blue-violet rim light" },
  { id: "nc_kesu", name: "The Censor", kanji: "消", reading: "けす", epithet: "Scribe of Every Burning", rarity: "SR", level: 39, style: "reaper", look: "a tall austere hollowed scribe in layered robes of many dead empires, ink-stained hands holding a brush that erases rather than writes, courteous cold expression, faded text dissolving around him, single crimson accent" },
  { id: "nc_wasure", name: "Halime", kanji: "忘", reading: "わすれ", epithet: "The Archivist Hollow", rarity: "SR", level: 43, style: "psyche", look: "an elderly Turkish woman librarian in Ottoman-era robes with kind tired eyes, a soft hollow in her chest quietly snowing library dust, holding a closed book to her heart, melancholy yet warm, loose expressive linework" },
  { id: "nc_moku", name: "White Noise", kanji: "黙", reading: "もく", epithet: "The Static That Silences", rarity: "SR", level: 45, style: "neon", look: "a faceless hollowed radio engineer, head wreathed in crackling visual static and broken empty speech-bubbles, wires and bent antennae, standing in a dead broadcast tower, oppressive, sickly neon" },
  { id: "nc_mu", name: "Mu", kanji: "無", reading: "む", epithet: "The Nameless, Named", rarity: "SSR", level: 50, style: "psyche", look: "a small quiet figure of gentle white emptiness — a person-shaped absence with softly dissolving edges — seated at peace at the edge of a warm circle of light, no face, the meaningful pause given form, minimalist negative space" },
];
